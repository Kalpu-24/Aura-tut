...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_DamageType_Lightning)
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_DamageType_Arcane)
...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Abilities_Types_Offensive)
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Abilities_Types_Passive)
...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Effect_HitReact)